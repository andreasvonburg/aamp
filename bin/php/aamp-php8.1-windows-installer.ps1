docker image rm -f andreasvonburg/aamp:php8.1

$aampProgamFilesPath = ([Environment]::GetFolderPath("ProgramFiles")) + "\Aamp"
New-Item $aampProgamFilesPath -Type Directory -Force

$aampBatFilePath = $aampProgamFilesPath + "\aamp-php8.1.bat"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/andreasvonburg/aamp/main/bin/php/aamp-php8.1.bat" -OutFile $aampBatFilePath

$aampIconPath = $aampProgamFilesPath + "\icon-8.1.ico"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/andreasvonburg/aamp/main/bin/php/icon-8.1.ico" -OutFile $aampIconPath

$aampStartPath = ([Environment]::GetFolderPath("CommonPrograms")) + "\Aamp"
New-Item $aampStartPath -Type Directory -Force

$shortcutPath = $aampStartPath + "\AAMP PHP 8.1.lnk"
...
Write-Host "AAMP PHP 8.1 has been installed." -ForegroundColor Green
