...
docker image rm -f andreasvonburg/aamp:php8.0 2>/dev/null || true
...
/opt/aamp/aamp-php8.0.command & sleep 1 # command somehow needs be called before renaming it to .app otherwise it gets Killed 9
sudo mv /opt/aamp/aamp-php8.0.command "/Applications/AAMP PHP 8.0.app"

echo "AAMP 8.0 installed."
